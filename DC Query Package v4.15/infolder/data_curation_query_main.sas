...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V4.14 - all queries,
...
data data;
     ...
     if obsgen_type in ("09" "10" "11" "ON" "SM" "HP" "HG" "LC" "RX" "ND" "HC" "GM" "CVX") or 
...
*- Derive appropriate counts and variables -*;
data query;
     length record_n $20 obsgen_type $30;
     if _n_=1 then set stats(where=(_type_=0) rename=(_freq_=denom));
     merge stats(where=(_type_=1)) 
     ;
     by col1;
