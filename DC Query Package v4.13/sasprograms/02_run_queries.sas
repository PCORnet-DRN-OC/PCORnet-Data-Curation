...
*    Study: PCORnet
*
*  Purpose: Run the query portion of PCORnet Data Curation Query Package v4.13
* 
*   Inputs: 
*	    1) PCORnet CDM v4.13 SAS data stores (datasets or views) 
...
********************************************************************************;
 ...
 /*Create CSV files of DMLOCAL data:*/                 %let _csv=Yes;
