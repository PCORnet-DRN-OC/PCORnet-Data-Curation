/*******************************************************************************/
*  $Source: run_code_errors $;
*    $Date: 2018/11/26
*    Study: PCORnet
*
*  Purpose: Run the code errors program v6.  This program was developed by the Coordinating Center to help partners identify ETL errors
...
*	    Work Plan. Heuristics will not identify all erroneous codes and may identify some valid codes. 
*	    Partners are not expected to clean or delete source data. 
* 
*   Inputs: 
*	    1) PCORnet CDM v4.1 SAS data stores (datasets or views) 
*	    2) SAS program:  /infolder/pcornet_code_errors.sas
*                                   
*
*  Outputs:
...
*	 	2) CSV versions of the 9 datasets stored in /dmlocal
