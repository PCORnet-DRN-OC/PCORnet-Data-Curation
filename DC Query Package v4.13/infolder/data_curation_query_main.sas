...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V4.13 - all queries,
...
data data;
     ...
     if px_type in ("09" "10" "11" "SM") then col1=px_type;
     else if px_type in ("NI") then col1="ZZZA";
     else if px_type in ("UN") then col1="ZZZB";
     else if px_type in ("OT") then col1="ZZZC";
     else if px_type=" " then col1="ZZZD";
...
data data;
     ...
     if obsclin_result_qual in ("POSITIVE" "NEGATIVE" "BORDERLINE" "ELEVATED" "HIGH" "LOW"
                        "NORMAL" "ABNORMAL" "UNDETERMINED") then col1=obsclin_result_qual;
...
data query;
     ...
     * table values *;
     ...
     if (d and s) or obsclin_result_unit in ("NI" "UN" "OT") then short_yn="Y";
     else short_yn="N";
...
data data;
     ...
     if obsgen_result_qual in ("POSITIVE" "NEGATIVE" "BORDERLINE" "ELEVATED" "HIGH" "LOW"
                        "NORMAL" "ABNORMAL" "UNDETERMINED") then col1=obsgen_result_qual;
...
data query;
     ...
     * table values *;
     ...
     if (d and s) or obsgen_result_unit in ("NI" "UN" "OT") then short_yn="Y";
     else short_yn="N";
...
data data;
     ...
     if obsgen_type in ("09" "10" "11" "ON" "SM" "HP" "HG" "LC" "RX" "ND" "HC" "GM" "CVX" "UD" "PC") then col1=obsgen_type;
...
data data;
     ...
     if obsgen_type in ("09" "10" "11" "ON" "SM" "HP" "HG" "LC" "RX" "ND" "HC" "GM" "CVX" "UD" "PC") then obsgentype=obsgen_type;
