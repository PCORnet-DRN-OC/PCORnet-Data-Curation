...
*    Study: PCORnet
*
*  Purpose: Prepare to run the Empirical Data Curation portion of Data Curation Query Package v6.05
* 
*   Inputs: 
*	   1) SAS datasets:   		/dmlocal/datasets created by the data curation queries. 
