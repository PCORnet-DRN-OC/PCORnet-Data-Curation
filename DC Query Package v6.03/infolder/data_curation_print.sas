...
*    Study: PCORnet
*
*  Purpose: Print PCORnet Data Curation Query Package V6.03
* 
...
%if &_yprovider=1 %then %do;
    ...
    %prnt(pdsn=prov_l3_specialty_enctype,_obs=100,_svar=provider_specialty_group,_suppvar=provider_specialty_primary enc_type record_n);
