...
*    Study: PCORnet
*
*  Purpose: Run the Empirical Data Characterization portion of PCORnet Data Characterization Query Package v3.04
* 
*   Inputs: 
...
*          2) required_structure.cpt - None
		   3) required_toc.cpt - None
*          4) edc_template.sas - None
*          5) edc_report.sas - Print of compiled EDC report in RTF file format 
