...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V6.10 - Lab queries only
* 
...
data data;
	...
	if index(RESULT_QUAL,":") and compress(tranwrd(strip(RESULT_QUAL), ' ',':'), '0123456789')^=':' then col1="ZZZB";
	if index(RESULT_QUAL,":") and compress(tranwrd(strip(RESULT_QUAL), ' ',':'), '0123456789')=':' then col1=RESULT_QUAL;		
