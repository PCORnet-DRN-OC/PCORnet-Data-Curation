...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V6.10 - all queries,
...
proc sql;
     create table dmlocal.&qname as select
         datamartid, response_date, query_package, payer_type_primary, admit_date, 
            record_n, distinct_patid_n
     from query;
quit;
...
data data;
     ...
     if upcase(sexual_orientation) in ("AS" "BI" "DC" "GA" "HO" "LE" "MU" "QS" "QU" "SE" "ST") 
...
data dummy_all;
     ...
     if nmiss(t01, t02, t03, t04, t05, t16)<6 then ord=sum(t01, t02, t03, t04, t05, t16);
...
data query;
     ...
     * call standard variables *;
     ...
     keep datamartid response_date query_package dataset token_encryption_key
          token distinct_patid_n svar;
run;
...
proc sql;
     create table dmlocal.&qname as select
         datamartid, response_date, query_package, dataset, token_encryption_key, 
         token, distinct_patid_n
     from query;
quit;
