...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V6.10 - 
...
%macro clean(savedsn);
     proc datasets  noprint;
          save _null xtbl_mdata_idsn elapsed cdm_version obsclin_codes
...
%global savedeath savedemog saveenc savediag saveproc saveenr savevit savepres 
        ...
        raw_lab_name savepenc mxrefreshn savextbl
        ;
...
%else %if %upcase(&_grp)=OBSCLIN %then %do;
    %include "&qpath.infolder/data_curation_query_obsclin.sas";
%end;
