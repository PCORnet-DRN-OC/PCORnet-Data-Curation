...
*    Study: PCORnet
*
*  Purpose: Run the Empirical Data Curation portion of Data Curation Query Package v6.10
* 
*   Inputs: 
...
*                       /dmlocal/datasets created by the 01_run_potential_code_errors.sas
						and 02_run_queries.sas programs.
*
*  Outputs: 
