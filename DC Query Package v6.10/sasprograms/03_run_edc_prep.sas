...
*    Study: PCORnet
*
*  Purpose: Prepare to run the Empirical Data Curation portion of Data Curation Query Package v6.10
* 
*   Inputs: 
*	   1) SAS datasets:   		/dmlocal/datasets created by the 01_run_potential_code_errors.sas
