...
*	    badndc.sas7bdat
*	    badloinc.sas7bat
*       code_errors_summary.sas7bdat (# and % of bad records per table)
...
options validvarname=upcase errors=0 mprint;
ods html close;
...
%macro summary;
data dmlocal.code_error_summary;
...
proc print width=min data=dmlocal.code_error_summary label;
	run;
