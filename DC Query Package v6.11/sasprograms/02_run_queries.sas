...
*    Study: PCORnet
*
*  Purpose: Run the query portion of Data Curation Query Package v6.11 
* 
*   Inputs: 
...
*                     (Example: Yes or No) (default is Yes for both). New in v6.11
...
********************************************************************************
* Submit data curation base program
********************************************************************************;
