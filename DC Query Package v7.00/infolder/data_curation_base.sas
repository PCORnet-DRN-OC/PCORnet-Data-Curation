...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package v7.00 - 
...
%macro tag(dset=,varlist=,qnam=,timer=,subset=,validall=,valid1=,valid2=,valid3=,valid4=,distinct=y,distvalid=,null=y);
    ...
    %if &&nobs_&dset>0 %then %do;
        ...
        %do i=1 %to &numvars;
            ...
            proc sort data=&dset (keep=&var
                ...
                %if &valid1=&i or &valid2=&i or &valid3=&i or &valid4=&i or %upcase(&validall)=Y %then %do; 
                    valid_&var
                %end;
                ) out=invar_sorted;
                by &var               
...
data elapsed_order;
    ...
    array txt (327) $100 _temporary_ ('DC PROGRAM' 
		...
		'CONDITION' 'COND_L3_N' 'COND_L3_STATUS' 'COND_L3_TYPE' 'COND_L3_SOURCE' 'COND_L3_CONDITION' 'COND_L3_RDATE_Y' 'COND_L3_RDATE_YM' 
