...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet EDC report V6.16
* 
...
********************************************************************************;
%global ets_inst _anydispensingdata _anyhashdata _anylabdata _anymedadmindata 
...
proc means data=dc_normal nway noprint;
     ...
     where datamartid=%upcase("&dmid") and statistic in ("RECORD_N") and 
           ((dc_name="LAB_L3_LOINC" and table="LAB_RESULT_CM" and variable="LAB_LOINC") or 
            (dc_name="PROCM_L3_LOINC" and table="PRO_CM" and variable="PRO_ITEM_LOINC") or 
