...
*    Study: PCORnet
*
*  Purpose: Print PCORnet Data Curation Query Package v7.03
* 
...
%if %upcase(&_dcpart)=_DCPART1 or %upcase(&_dcpart)=_ALL %then %do;
    ...
    %if &_yprocedures=1 %then %do;
        ...
        %prnt(pdsn=pro_l3_pxtype_enctype);
...
%if %upcase(&_dcpart)=_DCPART2 or %upcase(&_dcpart)=_ALL %then %do;
    %if &_yencounter=1 %then %do;
        ...
        %prnt(pdsn=enc_l3_adate_ym);
        %prnt(pdsn=enc_l3_enctype_adate_y);
        %prnt(pdsn=enc_l3_enctype_adate_ym,_obs=100,_svar=enc_type admit_date,_suppvar=record_n distinct_patid_n,origsort=y);
        %prnt(pdsn=enc_l3_ddate_y);
        %prnt(pdsn=enc_l3_ddate_ym);
        %prnt(pdsn=enc_l3_enctype_ddate_ym,_obs=100,_svar=enc_type discharge_date,_suppvar=record_n distinct_patid_n,origsort=y);
        ...
        %prnt(pdsn=enc_l3_payertype_y,_obs=100,_svar=payer_type_primary admit_date,_suppvar=record_n distinct_patid_n,origsort=y);
    %end;
    %if &_ydiagnosis=1 %then %do;    
        %prnt(pdsn=dia_l3_adate_y);
        %prnt(pdsn=dia_l3_adate_ym);
        %prnt(pdsn=dia_l3_dxdate_y);
        %prnt(pdsn=dia_l3_dxdate_ym);
        %prnt(pdsn=dia_l3_enctype_adate_ym,_obs=100,_svar=enc_type admit_date,_suppvar=record_n distinct_encid_n distinct_patid_n,origsort=y);
    ...
    %if &_yprocedures=1 %then %do;
        ...
        %prnt(pdsn=pro_l3_adate_ym);
        %prnt(pdsn=pro_l3_pxdate_y);
        %prnt(pdsn=pro_l3_pxtype_adate_y);
        %prnt(pdsn=pro_l3_enctype_adate_ym,_obs=100,_svar=enc_type admit_date,_suppvar=record_n distinct_encid_n distinct_patid_n,origsort=y);
    ...
    %if &_ydeath=1 %then %do;
        ...
        %prnt(pdsn=death_l3_date_ym);
        %prnt(pdsn=death_l3_source_ym,_obs=100,_svar=death_source death_date,_suppvar=record_n distinct_patid_n,origsort=y);
    %end;
    %if &_ydispensing=1 %then %do;
        %prnt(pdsn=disp_l3_ddate_y);
        %prnt(pdsn=disp_l3_ddate_ym);
    ...
    %if &_ycondition=1 %then %do;
        ...
        %prnt(pdsn=cond_l3_cond_condtype,_obs=100,_svar=condition,_suppvar=condition_type record_n record_pct distinct_patid_n);
        %prnt(pdsn=cond_l3_rdate_y);
        %prnt(pdsn=cond_l3_rdate_ym);
    %end;
    %if &_ypro_cm=1 %then %do;
        %prnt(pdsn=procm_l3_pdate_y);
        %prnt(pdsn=procm_l3_pdate_ym);
    ...
    %if &_yimmunization=1 %then %do;
        ...
        %prnt(pdsn=immune_l3_rdate_ym);
        %prnt(pdsn=immune_l3_adate_y);
        %prnt(pdsn=immune_l3_adate_ym);
    ...
    %if &_yobs_clin=1 %then %do;
        ...
        %prnt(pdsn=obsclin_l3_sdate_ym);
        %prnt(pdsn=obsclin_l3_code_unit,_obs=100,_svar=obsclin_code,_suppvar=obsclin_result_unit record_n);
        %prnt(pdsn=obsclin_l3_result_snomed,_obs=100,_svar=obsclin_result_snomed,_suppvar=record_n record_pct distinct_patid_n);
        ...
        %prnt(pdsn=obsclin_l3_loinc_result_num,_obs=100,_svar=obsclin_code,_suppvar=min p1 p5 p25 median p75 p95 p99 max n nmiss,_recordn=n);
    %end;
    %if &_ylab_result_cm=1 %then %do;
    ...
    %if &_ypat_relationship=1 %then %do;
        ...
        %prnt(pdsn=patrel_l3_sdate_ym);
    %end;
    %if &_yexternal_meds=1 %then %do;
        %prnt(pdsn=extmed_l3_rdate_y);
        %prnt(pdsn=extmed_l3_rdate_ym);
