...
*    Study: PCORnet
*
*  Purpose: Print PCORnet Data Curation Query Package V6.15
* 
...
%if %upcase(&_dcpart)=_DCPART2 or %upcase(&_dcpart)=_ALL %then %do;
    ...
    %if &_ypro_cm=1 %then %do;
        ...
        %prnt(pdsn=procm_l3_loinc,_obs=100,_svar=pro_item_loinc,_suppvar=panel_type record_n record_pct distinct_patid_n);
