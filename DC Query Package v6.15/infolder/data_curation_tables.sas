...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V6.15 - all queries,
  ...
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         record_n=strip(put(_freq_,16.));
         record_pct=put((_freq_/denom)*100,6.1);
  ...
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Determine the first and last year/month of the actual data -*;
    data minact(keep=year_month rename=(year_month=minact))
         ...
         set stats(where=(year_month<=&sys_year_month)) end=eof;
         if _n_=1 then do;
    ...
    *- Create a dummy dataset beginning with Jan of the first year, 
       extending to the last month of the run-date year -*;
    ...
    *- Add first and last actual year/month values to every record -*;
    data query;
         ...
         * counts *;
         record_n=strip(put(_freq_,16.));
         if distinct_patid^=. then distinct_patid_n=strip(put(distinct_patid,16.));
    ...
    *- Add first and last actual year/month values to every record -*;
    data query;
         length record_n distinct_patid_n $20;
         merge dummy stats pid_unique(rename=(_freq_=distinct_patid));
         by col1 year_month;
...
%if &_yencounter=1 %then %do;
    ...
    *- Need to generate ENC_L3_DASH/XTBL_L3_5ZIP data now for use in either part -*;
    data enc_l3_dash2;
    ...
    *- Uniqueness per PATID/period -*;
    proc sort data=enc_l3_dash2 out=enc_period_patid nodupkey;
         by period patid;
    run;

    *- Output for future XTBL -*;
    data xtbl_l3_5zip;
         set enc_period_patid;
         by period patid;
         if period in (1,5);
    run;
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savextbl enc_l3_dash2 enc_period_patid 
                   xtbl_l3_5zip);
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         record_n=strip(put(_freq_,16.));
         distinct_patid_n=strip(put(distinct_patid,16.));
         distinct_visit_n=strip(put(distinct_visit,16.));
         elig_record_n=strip(put(elig_record,16.));
         record_pct=put((_freq_/denom)*100,6.1);
    ...
    *- Derive statistics -*;
    proc means data=enc_period_patid(keep=period) nway completetypes noprint;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         distinct_patid_n=strip(put(_freq_,16.));
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savextbl xtbl_obs xtbl_l3_5zip);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if payer_type_primary=" " then col1="ZZZD";
         else if payer_type_primary="NI" then col1="ZZZA";
         else if payer_type_primary="UN" then col1="ZZZB";
         else if payer_type_primary="OT" then col1="ZZZC";
    ...
    *- Derive statistics - patid -*;
    ...
    data payer_type_primary_grp;
         length col1 payer_type_primary_grp $40;
         set payer_type;
         col1=code;
         payer_type_primary_grp=payer_type_grp;
         if start="ZZZA" then do;
            col1="ZZZA";
            payer_type_primary_grp="NI";
         end;
         else if start="ZZZB" then do;
            col1="ZZZB";
            payer_type_primary_grp="UN";
         end;
         else if start="ZZZC" then do;
            col1="ZZZC";
            payer_type_primary_grp="OT";
         end;
         else if start="ZZZD" then do;
            col1="ZZZD";
            payer_type_primary_grp="NULL or missing";
         end;
         else if start="ZZZE" then do;
            col1="ZZZE";
            payer_type_primary_grp="Values outside of CDM specifications";
         end;

        keep col1 payer_type_primary_grp;
    run;

    proc sort data=payer_type_primary_grp nodupkey;
         by col1;
    run;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         if _n_=1 then set stats(keep=_type_ _freq_ where=(_type_=0) 
                                 rename=(_freq_=denom));
         merge stats(where=(_type_=1)) 
               pid_unique(rename=(_freq_=distinct_patid))
         ...
         ;
         by col1;
         if col1 not in ("NI" "UN" "OT");

         * call standard variables *;
         %stdvar

         * table values *;
         if substr(col1,1,3)="ZZZ" then payer_type_primary=put(col1,$other.);
         else payer_type_primary=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if payer_type_secondary=" " then col1="ZZZD";
         else if payer_type_secondary="NI" then col1="ZZZA";
         else if payer_type_secondary="UN" then col1="ZZZB";
         else if payer_type_secondary="OT" then col1="ZZZC";
    ...
    *- Derive statistics - patid -*;
    ...
    data payer_type_secondary_grp;
         length col1 payer_type_secondary_grp $40;
         set payer_type;
         col1=code;
         payer_type_secondary_grp=payer_type_grp;
         if start="ZZZA" then do;
            col1="ZZZA";
            payer_type_secondary_grp="NI";
         end;
         else if start="ZZZB" then do;
            col1="ZZZB";
            payer_type_secondary_grp="UN";
         end;
         else if start="ZZZC" then do;
            col1="ZZZC";
            payer_type_secondary_grp="OT";
         end;
         else if start="ZZZD" then do;
            col1="ZZZD";
            payer_type_secondary_grp="NULL or missing";
         end;
         else if start="ZZZE" then do;
            col1="ZZZE";
            payer_type_secondary_grp="Values outside of CDM specifications";
         end;

        keep col1 payer_type_secondary_grp;
    run;

    proc sort data=payer_type_secondary_grp nodupkey;
         by col1;
    run;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then payer_type_secondary=put(col1,$other.);
         else payer_type_secondary=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if facility_type=" " then col1="ZZZD";
         else if facility_type="NI" then col1="ZZZA";
         else if facility_type="UN" then col1="ZZZB";
         else if facility_type="OT" then col1="ZZZC";
    ...
    *- Derive statistics - patid -*;
    ...
    data facility_type;
         length col1 facility_type_grp $100;
         set facility_type(rename=(facility_type_grp=facility_type_group));
         col1=start;

         if start="ZZZA" then facility_type_grp="NI";
         else if start="ZZZB" then facility_type_grp="UN";
         else if start="ZZZC" then facility_type_grp="OT";
         else if start="ZZZD" then facility_type_grp="NULL or missing";
         else if start="ZZZE" then
            facility_type_grp="Values outside of CDM specifications";
         else facility_type_grp=facility_type_group;

        keep start col1 facility_type_grp;
    run;

    proc sort data=facility_type nodupkey;
         by col1;
    run;

    *- Derive appropriate counts and variables -*;
    data query;
         length record_n distinct_patid_n $20 facility_type_grp $100
                facility_type $200;
         if _n_=1 then set stats(keep=_type_ _freq_ where=(_type_=0) 
                                rename=(_freq_=denom));
         ...
         ;
         by col1;
         if s and col1 not in ("NI" "UN" "OT");

         * call standard variables *;
         %stdvar

         * table values *;
         if substr(col1,1,3)="ZZZ" then facility_type=put(col1,$other.);
         else facility_type=strip(col1);
  ...
  ******************************************************************************;
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         record_n=strip(put(_freq_,16.));
         record_pct=put((_freq_/denom)*100,6.2);
         if denom_cat>0 then record_pct_cat=put((_freq_/denom_cat)*100,6.2);
         else record_pct_cat=" ";
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savextbl xtbl_l3_5zip);
    ...
    *- Derive categorical variable -*;
    data data;
	 ...
	 if payer_type_primary=" " then ptp="ZZZD";
         else if payer_type_primary="NI" then ptp="ZZZA";
         else if payer_type_primary="UN" then ptp="ZZZB";
         else if payer_type_primary="OT" then ptp="ZZZC";
    ...
    *- Derive statistics -*;
    proc means data=data nway completetypes noprint missing;
         class ptp col1/preloadfmt;
         output out=stats;
         format ptp $payer_type. col1 $null.;
    run;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         merge stats
               pid_unique(rename=(_freq_=distinct_patid));
         by ptp col1;
         if col1 not in ("NI" "UN" "OT") and ptp not in ("NI" "UN" "OT");

         * call standard variables *;
         %stdvar

         * table values *;
         if substr(ptp,1,3)="ZZZ" then payer_type_primary=put(ptp,$other.);
         else payer_type_primary=put(ptp,$payer_type.);
         admit_date=put(col1,$null.);

         * counts *;
         record_n=strip(put(_freq_,16.));
         if distinct_patid^=. 
            then distinct_patid_n=strip(put(distinct_patid,16.));
         else distinct_patid_n="0";
    ...
    *- Merge actual and dummy data -*;
    data stats;
         merge dummy_ym_missing dummy stats(in=s);
         by year_month;
    run;
...
/*               facility_type(in=f rename=(start=col1))*/;
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         else if facility_type=' ' then col1="ZZZD";
...
%if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savextbl xtbl_obs xtbl_l3_5zip);
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savextbl xtbl_l3_5zip);
    ...
    *- macro for query and, if requested, xtbl_obs query -*;
    %macro xtbl7(qname=dem_l3_patpreflang,dsn=,subset=);
      ...
      data data;
           ...
           if pat_pref_language_spoken=" " then col1="ZZZD";
           else if pat_pref_language_spoken in ("NI") then col1="ZZZA";
           else if pat_pref_language_spoken in ("UN") then col1="ZZZB";
           else if pat_pref_language_spoken in ("OT") then col1="ZZZC";
      ...
      *- Derive appropriate counts and variables -*;
      data query;
           ...
           * table values *;
           if substr(col1,1,3)="ZZZ" then pat_pref_language_spoken=put(col1,$other.);
           else pat_pref_language_spoken=strip(col1);
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog xtbl_l3_5zip);
...
%if &_ydiagnosis=1 %then %do;
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag xtbl_l3_5zip);
  ...
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         record_n=strip(put(_freq_,16.));
         distinct_encid_n=strip(put(_freq_encid,16.));
         distinct_patid_n=strip(put(_freq_patid,16.));
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         record_n=strip(put(_freq_,16.));
         distinct_patid_n=strip(put(distinct_patid,16.));
         distinct_encid_n=strip(put(distinct_encid,16.));
         record_pct=put((_freq_/denom)*100,6.1);
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         record_n=strip(put(_freq_,16.));
         if distinct_patid^=. 
            then distinct_encid_n=strip(put(_freq_encid,16.));
         else distinct_encid_n="0";
         if distinct_patid^=. 
            then distinct_patid_n=strip(put(distinct_patid,16.));
         else distinct_patid_n="0";
...
%if &_yprocedures=1 %then %do;
  ...
  data &qname(compress=yes);
       ...
       * define proceduresid_plus *;
       ...
       keep patid encounterid providerid proceduresid: px px_source ppx enc_type
            px_type admit_date px_date;
  run;
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc xtbl_l3_5zip);
...
%if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr xtbl_l3_5zip);
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then enr_basis=put(col1,$nullout.);
         else enr_basis=strip(col1);
  ...
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if ht^=. then do;
            col1=round(ht,1);
            htcat=put(col1,ht_dist.);
         end;

         keep col1 patid htcat;
    run;
    ...
    *- Derive statistics - patid -*;
    proc sort data=data out=pid(keep=col1) nodupkey;
         by htcat patid;
         where patid^=' ';
    run;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         record_n=compress(put(col1,16.1));
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if wt^=. then do;
            col1=round(wt,1);
            wtcat=put(col1,wt_dist.);
         end;
         keep col1 patid wtcat;
    run;
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if original_bmi^=. then col1=round(original_bmi,1);
         keep col1;
    run;
  ...
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if dispense_dose_disp_unit=" " then col1="ZZZD";
         else if dispense_dose_disp_unit="NI" then col1="ZZZA";
         else if dispense_dose_disp_unit="UN" then col1="ZZZB";
         else if dispense_dose_disp_unit="OT" then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         by col1;
         if d and col1 not in ('NI' 'UN' 'OT');

         * call standard variables *;
         %stdvar

         * table values *;
         if substr(col1,1,3)="ZZZ" then dispense_dose_disp_unit=put(col1,$other.);
         else dispense_dose_disp_unit=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if dispense_route=" " then col1="ZZZD";
         else if dispense_route="NI" then col1="ZZZA";
         else if dispense_route="UN" then col1="ZZZB";
         else if dispense_route="OT" then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then dispense_route=put(col1,$other.);
         else dispense_route=strip(col1);
...
%if &_yprescribing=1 %then %do;
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres xtbl_l3_5zip);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if rx_dose_form=" " then col1="ZZZD";
         else if rx_dose_form="NI" then col1="ZZZA";
         else if rx_dose_form="UN" then col1="ZZZB";
         else if rx_dose_form="OT" then col1="ZZZC";
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then rx_dose_form=put(col1,$other.);
         else rx_dose_form=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if rx_dose_ordered_unit=" " then col1="ZZZD";
         else if rx_dose_ordered_unit="NI" then col1="ZZZA";
         else if rx_dose_ordered_unit="UN" then col1="ZZZB";
         else if rx_dose_ordered_unit="OT" then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then rx_dose_ordered_unit=put(col1,$other.);
         else rx_dose_ordered_unit=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if rx_route=" " then col1="ZZZD";
         else if rx_route="NI" then col1="ZZZA";
         else if rx_route="UN" then col1="ZZZB";
         else if rx_route="OT" then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then rx_route=put(col1,$other.);
         else rx_route=strip(col1);
  ...
  ******************************************************************************;
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive statistics - RXNORM_CUI -*;
    proc sort data=data out=rxnorm_cui;
         by col1 rxnorm_cui;
         where rxnorm_cui^=" ";
    run;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         record_n=strip(put(_freq_,16.));
         record_n_rxcui=strip(put(record_rxcui,16.));
         distinct_patid_n=strip(put(distinct_patid,16.));
         record_pct=put((_freq_/denom)*100,6.1);
    ...
    *- Derive statistics -*;
    ...
    data query;
         ...
         * stats *;
         min=strip(put(rxmin,16.));
         mean=strip(put(rxmean,16.));
         max=strip(put(rxmax,16.));
         n=strip(put(rxn,16.));
         nmiss=strip(put(rxnmiss,16.));
...
%if &_ymed_admin=1 %then %do;
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm xtbl_l3_5zip);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if medadmin_dose_admin_unit=" " then col1="ZZZD";
         else if medadmin_dose_admin_unit="NI" then col1="ZZZA";
         else if medadmin_dose_admin_unit="UN" then col1="ZZZB";
         else if medadmin_dose_admin_unit="OT" then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then medadmin_dose_admin_unit=put(col1,$other.);
         else medadmin_dose_admin_unit=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if medadmin_route=" " then col1="ZZZD";
         else if medadmin_route="NI" then col1="ZZZA";
         else if medadmin_route="UN" then col1="ZZZB";
         else if medadmin_route="OT" then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then medadmin_route=put(col1,$other.);
         else medadmin_route=strip(col1);
  ...
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         set med_admin(keep=medadmin_code medadmin_type);
         if medadmin_type="RX" and medadmin_code^=" ";
...
%if &_yobs_gen=1 %then %do;
       ...
       * known test result *;
       if obsgen_code^=" " then do;
          ...
          if ((obsgen_result_num^=.  and obsgen_result_modifier not in (' ' 'NI' 'UN' 'OT')) or 
             obsgen_result_qual not in (" " "NI" "UN" "OT") or obsgen_result_text^=' ')
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm &saveobsgen xtbl_l3_5zip);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         else if obsgen_result_qual="NI" then col1="ZZZA";
         else if obsgen_result_qual="UN" then col1="ZZZB";
         else if obsgen_result_qual="OT" then col1="ZZZC";
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         col1=compress(strip(col1),'_');
         if substr(col1,1,3)="ZZZ" then obsgen_result_qual=put(col1,$other.);
         else obsgen_result_qual=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if obsgen_result_unit=" " then col1="ZZZD";
         else if obsgen_result_unit="NI" then col1="ZZZA";
         else if obsgen_result_unit="UN" then col1="ZZZB";
         else if obsgen_result_unit="OT" then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then obsgen_result_unit=put(col1,$other.);
         else obsgen_result_unit=strip(col1);
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         ...
         if obsgenunit not in ("ZZZA") then obsgen_result_unit=strip(obsgenunit);
         else obsgen_result_unit=put(obsgen_result_unit,$null.);
...
%if &_ypro_cm=1 %then %do;
  ...
  *- Determine length of variables to avoid truncation -*;
  ...
  data _null_;
       ...
       if name="PRO_ITEM_FULLNAME" then call symputx("_item_full_length",length);
       else if name="PRO_ITEM_NAME" then call symputx("_item_name_length",length);
       else if name="PRO_MEASURE_FULLNAME" then call symputx("_meas_full_length",length);
       else if name="PRO_MEASURE_NAME" then call symputx("_meas_name_length",length);
  run;
  ...
  data &qname(compress=yes);
       ...
       * restrict data to within lookback period *;
       if pro_date>=&lookback_dt or pro_date=. then flag=1;
  run;
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm &saveobsgen
                   &savecond &saveprocm xtbl_l3_5zip);
  ...
  ******************************************************************************;
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive statistics - unique patient -*;
    ...
    proc sort data=loinc(keep=loinc_num panel_type) 
         out=_loinc(rename=(loinc_num=col1));
         by loinc_num;
         where panel_type^=" ";
    run;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         length record_n distinct_patid_n $20;
         if _n_=1 then set stats(where=(_type_=0) rename=(_freq_=denom));
         merge stats(in=a where=(_type_=1)) 
               pid_unique(in=a rename=(_freq_=distinct_patid))
               _loinc
         ;
         by col1;
         if a;
         ...
         * counts *;
         ...
         keep datamartid response_date query_package pro_item_loinc panel_type
              record_n record_pct distinct_patid_n;
    run;
    ...
    *- Order variables -*;
    proc sql;
         create table dmlocal.&qname as select
             datamartid, response_date, query_package, pro_item_loinc, panel_type, 
             record_n, record_pct, distinct_patid_n
         from query;
    quit;
...
%if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm &saveobsgen
                   &savecond &saveprocm &saveprov xtbl_l3_5zip);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if provider_specialty_primary=" " then col1="ZZZD";
         else if provider_specialty_primary in ("NI") then col1="ZZZA";
         else if provider_specialty_primary in ("UN") then col1="ZZZB";
         else if provider_specialty_primary in ("OT") then col1="ZZZC";
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then provider_specialty_primary=put(col1,$other.);
         else provider_specialty_primary=strip(col1);
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then provider_specialty_group=put(col1,$other.);
         else provider_specialty_group=strip(col1);
    ...
    ****************************************************************************;
    ...
    proc sort data=encounter(keep=providerid enc_type) out=prov_encounter;
         by providerid;
         where providerid^=" ";
    run;
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if provider_specialty_primary=" " then col2="ZZZD";
         else if provider_specialty_primary in ("NI") then col2="ZZZA";
         else if provider_specialty_primary in ("UN") then col2="ZZZB";
         else if provider_specialty_primary in ("OT") then col2="ZZZC";
    ...
    *- Add encounter type -*;
    data data;
         ...
         ;
         by providerid;
         if d and e and enc_type^=" " and col1^="ZZZD";
    ...
    *- Derive statistics - providerid -*;
    ...
    data stats_group;
         merge stats(in=s where=(_type_=3))
               group(in=g)
         ;
         by col2;
         if s and g;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         length record_n distinct_providerid_n $20 
                provider_specialty_group provider_specialty_primary: $200;
         if _n_=1 then set stats(where=(_type_=0) rename=(_freq_=denom));
         merge stats_group(in=g)
               pid_unique(rename=(_freq_=distinct_providerid));
         ;
         by col2 enctype;
         if g and col1 not in ('NI' 'UN' 'OT') and col2 not in ('NI' 'UN' 'OT');
         ...
         * table values *;
         ...
         if substr(col1,1,3)="ZZZ" then provider_specialty_primary=put(col2,$other.);
         else provider_specialty_primary=strip(col2);
         enc_type=put(enctype,$enc_typ.);

         * counts *;
         record_n=strip(put(_freq_,16.));
         distinct_providerid_n=strip(put(distinct_providerid,16.));
...
%if &_yldsadrs=1 %then %do;
  ...
  data &qname(compress=yes) 
       xtbl_addr(keep=patid address_use address_type address_zip5);
       set pcordata.&qname;
       ...
       * for future XTBL query -*; 
       if zip5_valid="Y" and address_preferred="Y" and address_period_end=. and
          address_use not in ("WO" "TP" "OL") then output xtbl_addr;
  run;

  proc sort data=xtbl_addr;
       by address_use address_type;
  run;

  proc sort data=address_rank(keep=address_use address_type address_rank);
       by address_use address_type;
  run;

  data xtbl_addr;
       merge xtbl_addr(in=x) address_rank;
       by address_use address_type;
       if x;
       ar=input(address_rank,8.);
  run;
  ...
  proc means data=xtbl_addr nway noprint;
       class patid;
       var ar;
       output out=patid_ar min=min;
  run;

  data xtbl_addr;
       merge xtbl_addr patid_ar;
       by patid;
       if ar=min;
  run;

  data xtbl_l3_5zip_5y;
       merge  xtbl_addr(in=a) 
              xtbl_l3_5zip(in=x where=(period=5))
       ;
       by patid;
       if x and a;
       keep patid address_zip5;
  run;
    
  data xtbl_l3_5zip_1y;
       merge xtbl_addr(in=a)
             xtbl_l3_5zip(in=x where=(period=1))
       ;
       by patid;
       if x and a;
       keep patid address_zip5;
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm &saveobsgen
                   &savecond &saveprocm &saveldsadrs xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if address_state=" " then col1="ZZZD";
         else if address_state in ("NI") then col1="ZZZA";
         else if address_state in ("UN") then col1="ZZZB";
         else if address_state in ("OT") then col1="ZZZC";
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then address_state=put(col1,$other.);
         else address_state=strip(col1);
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm &saveobsgen
                   &savecond &saveprocm &saveldsadrs &saveimmune xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if vx_dose_unit=" " then col1="ZZZD";
         else if vx_dose_unit in ("NI") then col1="ZZZA";
         else if vx_dose_unit in ("UN") then col1="ZZZB";
         else if vx_dose_unit in ("OT") then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then vx_dose_unit=put(col1,$other.);
         else vx_dose_unit=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if vx_route=" " then col1="ZZZD";
         else if vx_route in ("NI") then col1="ZZZA";
         else if vx_route in ("UN") then col1="ZZZB";
         else if vx_route in ("OT") then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then vx_route=put(col1,$other.);
         else vx_route=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if vx_body_site=" " then col1="ZZZD";
         else if vx_body_site in ("NI") then col1="ZZZA";
         else if vx_body_site in ("UN") then col1="ZZZB";
         else if vx_body_site in ("OT") then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then vx_body_site=put(col1,$other.);
         else vx_body_site=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if vx_manufacturer=" " then col1="ZZZD";
         else if vx_manufacturer in ("NI") then col1="ZZZA";
         else if vx_manufacturer in ("UN") then col1="ZZZB";
         else if vx_manufacturer in ("OT") then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then vx_manufacturer=put(col1,$other.);
         else vx_manufacturer=strip(col1);
       ...
       * known test result *;
       if obsclin_code^=" " then do;
          ...
          if ((obsclin_result_num^=.  and obsclin_result_modifier not in (' ' 'NI' 'UN' 'OT')) or 
             obsclin_result_qual not in (" " "NI" "UN" "OT") or obsclin_result_text^=" ") 
             then known_test_result=1;
          else known_test_result=.;
  ...
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   ...
                   &saveobsclin xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         else if obsclin_result_qual="NI" then col1="ZZZA";
         else if obsclin_result_qual="UN" then col1="ZZZB";
         else if obsclin_result_qual="OT" then col1="ZZZC";
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         col1=compress(col1,'_');
         if substr(col1,1,3)="ZZZ" then obsclin_result_qual=put(col1,$other.);
         else obsclin_result_qual=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if obsclin_result_unit=" " then col1="ZZZD";
         else if obsclin_result_unit in ("NI") then col1="ZZZA";
         else if obsclin_result_unit in ("UN") then col1="ZZZB";
         else if obsclin_result_unit in ("OT") then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then obsclin_result_unit=put(col1,$other.);
         else obsclin_result_unit=strip(col1);
  ...
  ******************************************************************************;
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         ...
         if obsclinunit not in ("ZZZA") then obsclin_result_unit=strip(obsclinunit);
         else obsclin_result_unit=put(obsclinunit,$null.);

         * counts *;
         record_n=strip(put(_freq_,16.));
    
         keep datamartid response_date query_package obsclin_result_unit 
              obsclin_code record_n col1 obsclinunit;
    run;
    ...
    *- Derive categorical variable -*;
    data data;
         length col1 $15;
         set obs_clin(keep=obsclin_code patid obsclin_type 
                      where=(obsclin_type='LC'));
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         ...
         keep datamartid response_date query_package obsclin_code panel_type
              record_n record_pct distinct_patid_n;
    run;
    ...
    *- Order variables -*;
    proc sql;
         create table dmlocal.&qname as select
             datamartid, response_date, query_package, obsclin_code, panel_type, 
             record_n, record_pct, distinct_patid_n
         from query;
    quit;
...
%if &_ylab_result_cm=1 %then %do;
  ...
  ******************************************************************************;
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm &saveobsgen &savecond
                   &saveprocm &saveldsadrs &saveimmune &saveobsclin &savelab
                   xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if specimen_source=" " then col1="ZZZD";
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then specimen_source=put(col1,$other.);
         else specimen_source=strip(col1);
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm &saveobsgen
                   &savecond &saveprocm &saveldsadrs &saveimmune
                   &saveobsclin &savelab xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         col1=compress(strip(col1),"_");
         if substr(col1,1,3)="ZZZ" then result_qual=put(col1,$nullout.);
         else result_qual=strip(col1);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if lab_result_source in ("BI" "CL" "DR" "OD") 
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if result_unit=" " then col1="ZZZD";
         else if result_unit in ("NI") then col1="ZZZA";
         else if result_unit in ("UN") then col1="ZZZB";
         else if result_unit in ("OT") then col1="ZZZC";
    ...
    *- Re-order rows and format -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then result_unit=put(col1,$other.);
         else result_unit=strip(col1);
  ...
  ******************************************************************************;
  %if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Macro for each variable -*;
    ...
    %enc_oneway(encdsn=lab_result_cm,encvar=known_test_result_plausible,_nc=1,ord=8)
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         else if lab_loinc=" " then labloinc="ZZZD";
    
         if result_unit^=" " then col1=result_unit;
         else if result_unit=" " then col1="ZZZD";
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         ...
         if substr(labloinc,1,3)="ZZZ" then lab_loinc=put(labloinc,$other.);
         else lab_loinc=strip(labloinc);
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * counts *;
         ...
         keep datamartid response_date query_package lab_loinc panel_type 
              record_n record_pct distinct_patid_n;
    run;
    ...
    *- Order variables -*;
    proc sql;
         create table dmlocal.&qname as select
             datamartid, response_date, query_package, lab_loinc, panel_type, 
             record_n, record_pct, distinct_patid_n
         from query;
    quit;
    ...
    ****************************************************************************;
        ...
        *- If obs, continue through the rest of the query -*;
        %macro poss_nobs;
            ...
            %else %if &nobs=0 %then %do;
                 *- Create dummy dataset -*;
                 data query;
                      array v $16 lab_loinc min p1 p5 p25 median p75 p95 p99 
                                  max n nmiss;
    ...
    %else %do;
         *- Create dummy dataset -*;
         data query;
              array v $16 lab_loinc min p1 p5 p25 median p75 p95 p99 max n nmiss;
  ...
  %if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &saveenc &savedemog &savediag &saveproc &saveenr
                   &savevit &savedisp &savepres &savemedadm &saveobsgen
                   &savecond &saveprocm &saveldsadrs &saveimmune
                   &saveobsclin &savelab &savelabhistory xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
    ...
    *- Derive categorical variable -*;
    data data;
         ...
         if result_unit=" " then col1="ZZZD";
         else if result_unit="NI" then col1="ZZZA";
         else if result_unit="UN" then col1="ZZZB";
         else if result_unit="OT" then col1="ZZZC";
         else col1=put(result_unit,$_unit.);
...
%if %index(&_part1_mstring,%upcase(&tname))>0 %then %do;
  ...
  %elapsed(begin);
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &savedemog &saveenc &savediag &saveproc &saveenr 
                   ...
                   &saveimmune xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
  ...
  %elapsed(begin);
    ...
    %macro _dates(dsn,_vn,dtvlist,tmvlist1,tmvlist);
      ...
      %end;
             ...
             keep &dtvlist time: futureflag: preflag: invdtflag: imdtflag: 
                  invtmflag:;
        run;
    %mend _dates;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedeath &savedemog &saveenc &savediag &saveproc &saveenr 
                   ...
                   obs_gen_obsgen_stop_date xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
  ...
  %elapsed(begin);
    ...
    *- Macro to compare dates against birth and death -*;
    %macro xmin(idsn,var,ord);
      ...
      data min&var(keep=compvar b_cnt d_cnt ord);
           length compvar $20;
           merge min&idsn(in=m)
    ...
    %mend xmin;
    %if &_yencounter=1 %then %do;
        %xmin(idsn=encounter,var=admit_date,ord=1)
        %xmin(idsn=encounter,var=discharge_date,ord=2)
    %end;
    %if &_yprocedures=1 %then %do;
        proc sort data=procedures(keep=patid px_date admit_date) 
             out=procedures_dl;
             by patid;
        run;
    ...
    %end;
    %if &_yobs_clin=1 %then %do;
        proc sort data=obs_clin(keep=patid obsclin_start_date obsclin_stop_date) 
             out=obs_clin_dl;
             by patid;
        run;
        %xmin(idsn=obs_clin,var=obsclin_start_date,ord=10)
    %end;
    %if &_yobs_gen=1 %then %do;
        proc sort data=obs_gen(keep=patid obsgen_start_date obsgen_stop_date)
             out=obs_gen_dl;
             by patid;
        run;
        %xmin(idsn=obs_gen,var=obsgen_start_date,ord=11)
    %end;
    %if &_yimmunization=1 %then %do;
    ...
    *- Macro to compare dates within a data table -*;
    ...
    %mend within;
    %if &_yencounter=1 %then %do;
        proc sort data=encounter(keep=patid discharge_date admit_date) 
             out=encounter_dl;
             by patid; 
        run;
    ...
    *- Macro to compare dates across data tables -*;
    %macro across(idsn,mdsn,mvar,var,var2,adjp,adjm,ord);
        ...
        data &idsn&var(keep=patid cnt_across);
             merge &idsn&var &mdsn&var;
             by patid &mvar;
     
             retain cnt_across;
             if first.patid then cnt_across=0;
             if &var^=. and &var2^=. and &var &adjp < &var2 &adjm then cnt_across=1;
  ...
  %elapsed(begin);
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savedemog &savediag &saveenc &savelab &saveimmune &savevit 
                   &savepres &savemedadm nobs_all xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
  ...
  ******************************************************************************;
  %if &_ydemographic=1 and &_yencounter=1 %then %do;
    ...
    proc sort data=encounter(keep=patid admit_date) out=enc_2010;
         by patid;
    ...
    *- Derive categorical variable -*;
    data data;
         length col1 $4;
         merge xtbl_demog(in=d) enc_2010(in=e);
         by patid;
         if d and e;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savediag &saveenc &savelab &saveimmune &savevit &savepres 
                   &savemedadm nobs_all xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
  ...
  ******************************************************************************;
  %if &_ydiagnosis=1 and &_yvital=1 %then %do;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savediag &saveenc &savelab &saveimmune &savevit &savepres 
                   &savemedadm xdiagnosis xvital nobs_all xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
  ...
  ******************************************************************************;
  ...
  %elapsed(begin);
    ...
    *- Clear working directory -*;
    %clean(savedsn=&saveenc &savelab &saveimmune &savepres &savemedadm xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
...
%if %index(&_part2_mstring,%upcase(&tname))>0 %then %do;
  ...
  ******************************************************************************;
  %if &_yencounter=1 and &_ylab_result_cm=1 %then %do;
    ...
    proc sort data=encounter(keep=encounterid enc_type) 
         out=xlab_encounter nodupkey;
         by encounterid;
    run;

    proc sort data=lab_result_cm(keep=encounterid patid) out=xenc_lab_result_cm;
         by encounterid;
    run;
    ...
    *- If obs, continue through the rest of the query -*;
    %macro poss_nobs;
        ...
        *- Derive appropriate counts and variables -*;
        ...
        data query;
             length col1 $4 record_n distinct_patid_n $20 record_pct $6;
             ...
             * table values *;
             do col1  = "AV", "ED", "EI", "IC", "IP", "IS", "OA", "OS", "TH", 
                        "ZZZA", "ZZZB", "ZZZC", "ZZZD", "ZZZE";
                enc_type=put(col1,$enc_typ.);
                output;
             end;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savepres &savemedadm xlab_encounter xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
  ...
  ******************************************************************************;
  %if &_yencounter=1 and &_yprescribing=1 %then %do;
    ...
    proc sort data=prescribing(keep=encounterid patid) out=xenc_prescribing;
         by encounterid;
    run;
    ...
    *- If obs, continue through the rest of the query -*;
    %macro poss_nobs;
        ...
        *- Derive appropriate counts and variables -*;
        ...
        data query;
             length col1 $4 record_n distinct_patid_n $20;
    ...
    *- Clear working directory -*;
    %clean(savedsn=&savemedadm xlab_encounter xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
  %end;
  ...
  ******************************************************************************;
  %if &_ymed_admin=1 and &_yencounter=1 %then %do;
    ...
    proc sort data=med_admin(keep=encounterid patid) out=xenc_med_admin;
         by encounterid;
    run;
    ...
    *- Clear working directory -*;
    %clean(savedsn=xtbl_l3_5zip_5y xtbl_l3_5zip_1y);
  ...
  %if &_yldsadrs=1 and &_yencounter=1 %then %do;
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         ...
         * table values *;
         if substr(col1,1,3)="ZZZ" then address_zip5=put(col1,$null.);
         else address_zip5=strip(col1);
...
%if &_yhash_token=1 %then %do;
    ...
    *- Create binomial variables of the presence of a token value -*;
    data data(keep=token_encryption_key token patid var);
         ...
         if patid^=" " and token_encryption_key^=" ";
    ...
    *- Merge dummy with actual and create column variables -*;
    data query;
         length dataset token $30 distinct_patid_n $20;
         ...
         * counts *;
         if s then distinct_patid_n=strip(put(distinct_patid,16.));
