...
*    Study: PCORnet
*
*  Purpose: Run the query portion of PCORnet Data Curation Query Package v4.10
* 
*   Inputs: 
...
*    	1) Up to 5 SAS datasets stored in /dmlocal and 1 summary dataset of the results for all code types.  
* 			baddx.sas7bdat
*	    	badpx.sas7bdat
*	    	badrxcui.sas7bdat
*	    	badndc.sas7bdat
