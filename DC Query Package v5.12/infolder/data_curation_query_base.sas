...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V5.12 - 
...
data _null_;
     ...
     * DASH queries, cut-off three months prior to system run date and 12 mth intervals *;
...
%macro clean(savedsn);
     proc datasets  noprint;
          save xtbl_mdata_idsn elapsed 
               ...
               rx_dose_form progress vxbodysite vxmanu &savedsn / memtype=data;
