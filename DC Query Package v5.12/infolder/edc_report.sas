...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet EDC report v5.12
* 
...
%macro clean(savedsn);
     proc datasets  noprint;
          save dc_normal toc headers footers chart_months dc_summary missingness
               ...
               lab_volume_ref &savedsn / memtype=data;
...
data _null_;
     ...
     call symput("ets_inst",propcase("&_ets_installed"));
...
data print_ig;
     ...
     * create column variables and output *;
     ...
     if dist_patid=0 or (lower_bound^=. and dist_patid<lower_bound) then do;
        col4flag=1;
        col4c="Yes";
     end;
     else do;
...
data denom;
     merge dc_normal(where=(datamartid=%upcase("&dmid") and dc_name="DIA_L3_N" and variable="ENCOUNTERID" and statistic="DISTINCT_N") 
           ...
           dc_normal(where=(datamartid=%upcase("&dmid") and dc_name="DEM_L3_N" and variable="PATID" and statistic="DISTINCT_N") rename=(resultn=pat_dem))
...
data final;
     ...
     if row in (8,9,10,12,14) then do;
...
proc format;
     invalue rowfmt
        ...
        'OBSCLIN_DATE < BIRTH_DATE'=11
        'OBSGEN_DATE < BIRTH_DATE'=12
        ...
        'OBSCLIN_DATE > DEATH_DATE'=23
        'OBSGEN_DATE > DEATH_DATE'=24
...
data print_iiic;
     ...
     * create column variables and output *;
     if ord<27 then col1=strip(category);
...
data data;
     ...
     if cross_category in ('BLD' 'BLD.DOT' 'BLD_TISS' 'BLD_TISS^DONOR' 'BLDA' 'BLDC' 
                           ...
                           'PLAS' 'PPP' 'PPP_BLD' 'PPP^FETUS' 'BLD^CONTROL' 'SER_BLD'
                           'BLD^BPU' 'BLD^NEWBORN' 'BLD^PATIENT' 'BLDCRRT' 'PLASV' 
                           'SER_PLAS^BPU' 'SER+CSF' 'BLD_BONE_MAR^DONOR') then do;
        source_cat=1;
        if cross_category2 in ('BLD' 'BLD.DOT' 'BLD_TISS' 'BLD_TISS^DONOR' 'BLDA' 'BLDC' 
                           ...
                           'PLAS' 'PPP' 'PPP_BLD' 'PPP^FETUS' 'BLD^CONTROL' 'SER_BLD'
                           'BLD^BPU' 'BLD^NEWBORN' 'BLD^PATIENT' 'BLDCRRT' 'PLASV' 
                           'SER_PLAS^BPU' 'SER+CSF' 'BLD_BONE_MAR^DONOR') then exp_cat=1;
        else exp_cat=2;
     end;
     ...
     else if cross_category in ("URINE" "URINE_SED" "URINE+SER_PLAS") then do;
        source_cat=3;
        if cross_category2 in ("URINE" "URINE_SED" "URINE+SER_PLAS") then exp_cat=1;
        else exp_cat=2;
     end;
     else if cross_category in ('AMNIO_FLD' 'BODY_FLD' 'GAST_FLD' 'PERICARD_FLD' 'PERITON_FLD'
                                'PLR_FLD' 'SALIVA' 'SEMEN' 'SPUTUM' 'SWEAT' 'SYNV_FLD''ABSCESS') then do;
        source_cat=4;
        if cross_category2 in ('AMNIO_FLD' 'BODY_FLD' 'GAST_FLD' 'PERICARD_FLD' 'PERITON_FLD'
                                'PLR_FLD' 'SALIVA' 'SEMEN' 'SPUTUM' 'SWEAT' 'SYNV_FLD' 'ABSCESS') then exp_cat=1;
        else exp_cat=2;
     end;
     ...
     else if cross_category in ('CVX' 'CVX_VAG' 'CERVIX' 'CVM' 'ENDOCERVICAL_BRUSH' 'VAG+RECTUM') then do;
        source_cat=6;
        if cross_category2 in ('CVX' 'CVX_VAG' 'CERVIX' 'CVM' 'ENDOCERVICAL_BRUSH' 'VAG+RECTUM') then exp_cat=1;
        else exp_cat=2;
     end;
...
%if %upcase(&_ets_installed)=YES %then %do;
...
proc format cntlout=o_field;
     value $o_field
        ...
        "CONDITION_SOURCE"="57"
        "CONDITION_TYPE"="58"
        "DEATH_CAUSE_CONFIDENCE"="59"
        "DEATH_CAUSE_SOURCE"="60"
        "DEATH_CAUSE_TYPE"="61"
        "DEATH_CAUSE_CODE"="62"
        "PROCM_ENCOUNTERID"="63"
        "PRO_ITEM_LOINC"="64"
        "PRO_DATE"="65"
        "PRO_TIME"="66"
        "PRO_METHOD"="67"
        ...
        "PRO_TYPE"="70"
        "PRO_ITEM_NAME"="71"
        "PRO_ITEM_FULLNAME"="71"
        "PRO_MEASURE_NAME"="73"
        "PRO_MEASURE_FULLNAME"="74"
        "PRO_SOURCE"="75"
        "PROVIDER_NPI"="76"
        ...
        "OBSCLIN_CODE"="93"
        "OBSCLIN_TYPE"="94"
        "OBSCLIN_RESULT_QUAL"="95"
        "OBSCLIN_RESULT_MODIFIER"="96"
        "OBSCLIN_RESULT_UNIT"="97"
        "OBSGEN_ENCOUNTERID"="98"
        "OBSGEN_PROVIDERID"="99"
        "OBSGEN_DATE"="100"
        "OBSGEN_TIME"="101"
        "OBSGEN_CODE"="102"
        "OBSGEN_TYPE"="103"
        "OBSGEN_RESULT_QUAL"="104"
        "OBSGEN_RESULT_MODIFIER"="105"
        "OBSGEN_RESULT_UNIT"="106"
        "ADDRESS_USE"="107"
        "ADDRESS_TYPE"="108"
        "ADDRESS_PREFERRED"="109"
        "ADDRESS_CITY"="110"
        "ADDRESS_STATE"="111"
        "ADDRESS_ZIP5"="112"
        "ADDRESS_ZIP9"="113"
        "ADDRESS_PERIOD_START"="114"
        "ADDRESS_PERIOD_END"="115"
        "IMMUNE_ENCOUNTERID"="116"
        "PROCEDURESID"="117"
        "VX_PROVIDERID"="118"
        "VX_RECORD_DATE"="119"
        "VX_ADMIN_DATE"="120"
     ...
     value $o_source
        ...
        "70"="PROCM_L3_TYPE"
        "71"="PROCM_L3_ITEMNM"
        "72"="PROCM_L3_ITEMFULLNAME"
        "73"="PROCM_L3_MEASURENM"
        "74"="PROCM_L3_MEASUREFULLNAME"
        "75"="PROCM_L3_SOURCE"
        "76"="PROV_L3_N"
        "77"="PROV_L3_NPIFLAG"
       ...
       "100"="XTBL_L3_DATES"
       "101"="XTBL_L3_TIMES"
       "102"="OBSGEN_L3_CODE_TYPE"
       "103"="OBSGEN_L3_TYPE"
       "104"="OBSGEN_L3_QUAL"
       "105"="OBSGEN_L3_MOD"
       "106"="OBSGEN_L3_UNIT"
       "107"="LDSADRS_L3_ADRSUSE"
       "108"="LDSADRS_L3_ADRSTYPE"
       "109"="LDSADRS_L3_ADRSPREF"
       "110"="LDSADRS_L3_ADRSCITY"
       "111"="LDSADRS_L3_ADRSSTATE"
       "112"="LDSADRS_L3_ADRSZIP5"
       "113"="LDSADRS_L3_ADRSZIP9"
       "114"="XTBL_L3_DATES"
       "115"="XTBL_L3_DATES"
       "116"="IMMUNE_L3_N"
       "117"="IMMUNE_L3_N"
       ...
       "119"="XTBL_L3_DATES"
       "120"="XTBL_L3_DATES"
       "121"="IMMUNE_L3_CODETYPE"
       "122"="IMMUNE_L3_STATUS"
       "123"="IMMUNE_L3_STATUSREASON"
       "124"="IMMUNE_L3_SOURCE"
       "125"="IMMUNE_L3_DOSE_DIST"
       "126"="IMMUNE_L3_DOSEUNIT"
       "127"="IMMUNE_L3_ROUTE"
       "128"="IMMUNE_L3_BODYSITE"
       "129"="IMMUNE_L3_MANUFACTURER"
       "130"="IMMUNE_L3_LOTNUM"
       "131"="XTBL_L3_DATES"
        ;
run;
...
data dum_field;
     ...
     else if 52<=ordn<=58 then table="CONDITION";
     else if 59<=ordn<=62 then table="DEATH_CAUSE";
     else if 63<=ordn<=75 then table="PRO_CM";
     else if 76<=ordn<=79 then table="PROVIDER";
     else if 80<=ordn<=88 then table="MED_ADMIN";
     else if 89<=ordn<=97 then table="OBS_CLIN";
     else if 98<=ordn<=106 then table="OBS_GEN";
     else if 107<=ordn<=115 then table="LDS_ADDRESS";
     else if 116<=ordn<=131 then table="IMMUNIZATION";
...
data print_ivi;
     ...
     set loinc(in=l)
         data(where=(variable not in ("LAB_RESULT_CM_ID" "KNOWN_TEST_RESULT_NUM_SRCE_UNIT" "KNOWN_TEST_RESULT_NUM_SOURCE")))
     ;
