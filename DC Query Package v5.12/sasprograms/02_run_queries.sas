...
*    Study: PCORnet
*
*  Purpose: Run the query portion of PCORnet Data Curation Query Package v5.12
* 
*   Inputs: 
...
*              If all data curation queries are run at once
*				[DMID]_[DATE]_data_curation_all.pdf 
*				OR
*			   If data curation queries are run separately
*				[DMID]_[DATE]_data_curation_main.pdf
*				[DMID]_[DATE]_data_curation_lab.pdf
*				[DMID]_[DATE]_data_curation_xtbl.pdf
*           3) SAS transport file of SAS datasets for each query stored in /drnoc
*				If all data curation queries are run at once
*				 [DMID]_[DATE]_data_curation_all.cpt
*				OR
*				If data curation queries are run separately
*				 [DMID]_[DATE]_data_curation_main.cpt
*				 [DMID]_[DATE]_data_curation_lab.cpt
*				 [DMID]_[DATE]_data_curation_xtbl.cpt
*           4) SAS log file of query portion stored in /drnoc
*				If all data curation queries are run at once
*                [DMID]_[DATE]_data_curation_all.log
*				 [DMID]_[DATE]_data_curation_base.log
*				OR
*				If data curation queries are run separately
*				  [DMID]_[DATE]_data_curation_base.log
*				  [DMID]_[DATE]_data_curation_main.log
*			      [DMID]_[DATE]_data_curation_lab.log
*				  [DMID]_[DATE]_data_curation_xtbl.log
*           5) SAS dataset of DataMart meta-data stored in /dmlocal
*                (datamart_all.sas7bdat)
*           6) A rtf file containing table names and their processing time  stored in /drnoc
*				[DMID]_[DATE]_data_curation_progress_report.rtf
*
*  Requirements:  
...
*               4) User provides the whether CSV outputs are desired (section below)
...
********************************************************************************;
 ...
 /*Enter query group to process: (lab, main, xtbl, all)*/  %let _grp=all;

 /*Enter lookback years.DO NOT MODIFY UNLESS 
 INSTRUCTED TO DO SO*/                                 %let lookback = 20;
