/*******************************************************************************
*  $Source: 02_run_queries $;
*    $Date: 2018/09/27
*    Study: PCORnet
*
*  Purpose: Run the data curation query portion of PCORnet Data Curation Query Package v4.13
* 
*   Inputs: 
*	    1) PCORnet CDM v4.1 SAS data stores (datasets or views) 
*	    2) SAS programs: data_curation_query_base.sas stored in /infolder
*                        data_curation_query_main.sas stored in /infolder
*  						 data_curation_query_lab.sas stored in /infolder
* 						 data_curation_query_xtbl.sas stored in /infolder
...
*                (e.g. <DataMart Id>_<response date>_data_curation_query_all.pdf)
...
*                (e.g.<DataMart Id>_<response date>_data_curation_query_main.log)
...
********************************************************************************
* Submit data curation query programs
********************************************************************************;
