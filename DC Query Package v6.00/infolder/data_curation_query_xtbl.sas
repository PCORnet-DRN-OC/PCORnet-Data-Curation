...
data data;    
     length networkid network_name datamartid datamart_name query_package tag 
            ...
            token_encryption_key birth_date_mgmt enr_start_date_mgmt enr_end_date_mgmt 
            ...
            medadmin_stop_date_mgmt obsclin_start_date_mgmt obsclin_stop_date_mgmt 
     ...
     * table variables *;
     ...
     cdm_version=strip(put(cdm_version_num,6.0));
...
proc transpose data=data out=query(rename=(_name_=name col1=value));
     var networkid network_name datamartid datamart_name datamart_platform
         ...
         low_cell_cnt operating_system query_package lookback_months 
