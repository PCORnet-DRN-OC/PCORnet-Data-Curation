...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V5.13 - Lab queries only
* 
...
data _null_;
     ...
     if name="SPECIMEN_SOURCE" then call symputx("_specimen_source_length",max(length,15));
run;
...
%macro _5yrlook(sufx,subset);
    ...
    *- Derive appropriate counts and variables -*;
    data query;
         length record_n $20 specimen_source $&_specimen_source_length;
         set stats;
