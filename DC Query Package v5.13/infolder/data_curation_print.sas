...
*    Study: PCORnet
*
*  Purpose: Print PCORnet Data Curation Query Package V5.13
* 
...
%if &_ymed_admin=1 %then %do;
    ...
    %prnt(pdsn=medadm_l3_doseadmunit,_obs=100,_svar=medadmin_dose_admin_unit short_yn,_suppvar=record_n record_pct);
