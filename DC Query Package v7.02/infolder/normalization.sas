...
*    Study: PCORnet
*
*  Purpose: To consolidate PCORnet Data Curation Query Package V7.01
...
%if %upcase(&_dcpart)=_DCPART1 or %upcase(&_dcpart)=_ALL %then %do;
    ...
    %if &_yldsadrs=1 %then %do;
        ...
        %_recordn(dsn=LDSADRS_L3_CURRENT,type=_recordn,var=CURRENT_ADDRESS_FLAG,addvar=record_n record_pct)
