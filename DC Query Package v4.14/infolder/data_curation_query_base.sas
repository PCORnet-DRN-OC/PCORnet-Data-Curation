...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V4.14 - 
...
%macro clean(savedsn);
     proc datasets  noprint;
          save xtbl_mdata_idsn elapsed short_x_unit short_result_unit short_source 
               ...
               rxnorm_cui_ref rx_dose_form progress &savedsn / memtype=data;
...
%global savedeath savedemog saveenc savediag saveproc saveenr savevit savepres 
        ...
        _yencounter _yenrollment _yharvest _ylab_result_cm _ymed_admin _yobs_clin
        _yobs_gen _yprescribing _yprocedures _ypro_cm _yprovider _yvital _yptrial
        raw_lab_name
        ;
