...
*    Study: PCORnet
*
*  Purpose: Produce PCORnet Data Curation Query Package V5.10 - 
...
%macro clean(savedsn);
     proc datasets  noprint;
          save xtbl_mdata_idsn elapsed 
               ...
               dx_dcgroup_ref px_dcgroup_ref rxnorm_cui_ref rx_dose_form progress
               vxbodysite vxmanu &savedsn / memtype=data;
...
%global savedeath savedemog saveenc savediag saveproc saveenr savevit savepres 
        ...
        saveobsgen saveprov saveldsadrs saveimmune savehashtoken
        _ycondition _ydeath _ydeathc _ydemographic _ydiagnosis _ydispensing 
        _yencounter _yenrollment _yharvest _yhash_token _yimmunization _ylab_result_cm 
        _yldsadrs _ymed_admin _yobs_clin _yobs_gen _yprescribing _yprocedures 
        _ypro_cm _yprovider _yvital _yptrial raw_lab_name
        ;
